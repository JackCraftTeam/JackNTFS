...
namespace JackNTFS
{
    internal class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            ShowDrives(driveInfoList, allDrives);
        ...
        /// <summary>
        /// Show all the drives you have on your PC.
        /// *I WANT THEM ALL!!!!!!   -- William*
        /// </summary>
        /// <returns>Returns false once failed accessing;</returns>
        private static void ShowDrives(List<DriveInfo> driveInfoList, DriveInfo[] allDrives)
        {
